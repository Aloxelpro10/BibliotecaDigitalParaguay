...
- `Libro.css`: estilo de la vista de detalle del libro.
...
- `book-detail.js`: sincroniza la página de detalle con el catálogo y crea el QR.
...
- `biblioteca_libros/pdfs/`: PDFs actuales del proyecto.
